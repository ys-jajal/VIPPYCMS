...
Partial Class Experiance
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim query As String
        query = "select * from experiance where uname ='" & str1 & "'"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Session("login") = True Then
            'sqlBalanced.Update()
            nm = Session("uname")
            query = "update experiance set lbl1='" & lbl1 & "',lbl2='" & lbl2 & "',lbl3='" & lbl3 & "',lbl4='" & lbl4 & "',lbl5='" & lbl5 & "',lbl6='" & lbl6 & "',lbl7='" & lbl7 & "',lbl8='" & lbl8 & "',lbl9='" & lbl9 & "',lbl10='" & lbl10 & "',lbl11='" & lbl11 & "',sitename='" & sname & "',page='Balanced.aspx' , fstyle='" & fstyle & "', fsize=" & fsize & ", fname='" & fname & "', fcolor='" & fcolor & "' where uname='" & nm & "'"
            cmd = New SqlCommand(query, con)
            MsgBox("Update")
        ElseIf Session("SignUp") = True Then
            'sqlBalanced.Insert()
            nm = Session("new")
            query = "insert into experiance(lbl1,lbl2,lbl3,lbl4,lbl5,lbl6,lbl7,lbl8,lbl9,lbl10,lbl11,sitename,page,uname,fstyle,fsize,fname,fcolor) values('" & lbl1 & "','" & lbl2 & "' ,'" & lbl3 & "','" & lbl4 & "','" & lbl5 & "','" & lbl6 & "','" & lbl7 & "','" & lbl8 & "','" & lbl9 & "','" & lbl10 & "','" & lbl11 & "','" & sname & "','Experiance.aspx','" & nm & "','" & fstyle & "','" & fsize & "','" & fname & "','" & fcolor & "')"
            cmd = New SqlCommand(query, con)
            MsgBox("insert")
        End If
